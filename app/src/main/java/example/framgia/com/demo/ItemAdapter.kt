...
class ItemAdapter : RecyclerView.Adapter<ItemAdapter.Companion.ItemHolder>() {
    ...
    companion object {
        ...
        class ItemHolder(itemView: View, private var itemClick: ItemClick) : RecyclerView.ViewHolder(
            itemView
            ...
            override fun onClick(v: View) {
                itemClick.onItemClick(v, user, adapterPosition)
            }
